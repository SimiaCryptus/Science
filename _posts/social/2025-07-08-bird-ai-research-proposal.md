...
## Executive Summary
![**Figure 1:** Conceptual visualization of the experimental interface, where organic avian vocalizations meet real-time autoregressive AI responses to test social cognition boundaries.](../../assets/images/avian_ai_interaction_concept.png)
...
```
![**Figure 2:** The Autoregressive Social Prediction Framework. This model illustrates how organisms integrate past interaction history, current mental models, and environmental context to predict the future behavior of social partners.](../../assets/images/autoregressive_social_prediction_flowchart.png)
...
![**Figure 3:** Neural substrate of autoregressive processing. The precise temporal firing sequence of HVC neurons (top) maps directly to the production of song motifs (bottom), creating a biological mechanism for temporal prediction.](../../assets/images/hvc_neural_cascade_spectrogram.png)
...
![**Figure 4:** Visualizing song dialects as spatially-embedded truth systems. The propagation of vocal traditions follows cellular automaton dynamics, where local interaction rules determine the stability and evolution of cultural boundaries.](../../assets/images/song_dialect_cellular_automata_map.png)
...
![**Figure 5:** The Autoregressive Hijacking Hypothesis. Contrast between natural social learning (A), which relies on reciprocal stakes, and AI interaction (B), which creates an open-loop system leading to potential cognitive overload and theory of mind disruption.](../../assets/images/social_feedback_loop_comparison.png)
