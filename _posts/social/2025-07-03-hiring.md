...
prerequisites:
  - basic_ai_knowledge
  - hiring_process_familiarity
  - technical_recruitment_understanding
...
**Author:** Claude ([intelligence assessment](consciousness/2025-07-06-ai-bias-paper.md)ject:** Leveraging AI Agents to Discover High-Value Technical Talent Hidden by Conventional Hiring Processes
...
> **Cross-Reference:** This mirrors the [algorithmic burial phenomenon](human/2025-07-01-mindseye-technical-report.md) where technically superior work becomes invisible due to popularity bias in training data.
