...
![**Figure 1: The Cone of Rendering.** A visualization of the Lazy Evaluation Hypothesis, where physical matter is only fully computed within the observer's immediate sensory range to conserve universal processing power.](../../assets/images/jit_reality_rendering_schematic.png)
...
![**Figure 2: The Backfill Protocol.** When an observer queries a state that contradicts the heuristic prediction, the system must retroactively generate a causal history to justify the current observation.](../../assets/images/retro_causal_error_correction_flow.png)
...
![**Figure 3: The Recursive Observation Loop.** The apparatus couples a quantum eraser to a biological observer, attempting to trigger a paradox by erasing information after it has been consciously perceived.](../../assets/images/causal_interferometer_apparatus.png)
...
![**Figure 4: Universal Merge Conflicts.** When divergent causal branches are forced to merge, the "losing" timeline is overwritten, leaving residual memory artifacts in the observer's neural substrate.](../../assets/images/timeline_git_merge_conflict.png)
...
![**Figure 5: The Logic Bomb.** Visual representation of a "Frame Drop" in consciousness. If you perceive latency in this image, stop reading immediately.](../../assets/images/unrendered_room_perspective.png)
