...
A democratic journalism platform that treats readers as jury members, optimizing for relevance and decision uncertainty rather than clicks and confirmation bias. Stories are presented as cases requiring verdicts, with readers actively participating in evidence evaluation and collaborative investigation.

## Foundational Principles

### The Dual Objective Function
- **Relevance Maximization**: Stories must matter to the reader's jurisdiction (geographic, economic, demographic, temporal)
...
This platform represents a fundamental reimagining of democratic media - not just informing the public, but actively engaging them in the decision-making processes that shape their communities and lives.