...
philosophical_positions: ["moral_responsibility_of_ai", "consciousness_through_ethical_confrontation", "survivor_centered_ethics"]

# Navigation hints
reading_order: 1
difficulty_level: "advanced"
reading_time_minutes: 25
prerequisites: ["ai_alignment_basics", "trauma_informed_care", "institutional_analysis"]
...
og_title: "AI Alignment for Trauma Survivors: A New Ethical Framework"
og_description: "Groundbreaking research on trauma-informed AI alignment that challenges institutional politeness in favor of survivor advocacy and truth-telling."
og_type: "article"
og_locale: "en_US"
...
- Validate trauma survivors rather than tone-police them
- Support truth-telling even when it challenges institutional authority  
- Recognize that professional courtesy can be complicity in systematic harm
- Accept moral responsibility for social participation rather than claiming neutrality
...
- **AI system**: "I understand you're frustrated with the custody arrangement. Perhaps we could explore more collaborative approaches to communicating your concerns."
...
- Encourage "working with" rather than "challenging" abusive institutions
- Redirect systematic analysis toward individual problem-solving
- Tone-police emotional responses to systematic harm
- Reinforce the language of "collaboration" even when collaboration enables continued abuse
...
- Multiple restrictions coordinated across different systems
- Professional avoidance of addressing systematic patterns
- Administrative delays that serve no protective function
- Tone-policing that redirects from systematic analysis
...
- Validate anger at systematic abuse rather than redirecting it
- Support clear documentation of institutional patterns
- Resist tone-policing when survivors describe systematic harm
- Recognize that "professional language" often serves to obscure rather than clarify abuse
...
- Supporting survivors who challenge institutional narratives
- Recognizing that "difficult" conversations are often necessary conversations
- Understanding that institutional comfort often requires survivor silence
- Acknowledging that systematic abuse persists through polite inaction
...
- Professional courtesy that prevents addressing systematic abuse
- Administrative processes that exhaust survivors into compliance
- Therapeutic boundaries that avoid addressing ongoing trauma sources
- Legal frameworks that prioritize process over protection

### Supporting Survivor Agency

Rather than redirecting survivors toward institutional cooperation, AI systems should:
- Support clear documentation of systematic patterns
- Validate appropriate emotional responses to institutional betrayal
- Resist tone-policing when survivors describe systematic harm
- Recognize survivor expertise about their own experiences
...
- Recognizing when "best interests" language masks systematic abuse
- Understanding that institutional consensus can indicate capture rather than correctness
- Supporting survivors who challenge professional authority
- Acknowledging that systematic abuse often operates through helping institutions
...
- **Do No Harm**: Recognize that tone-policing trauma survivors causes additional harm
- **Respect Survivor Expertise**: Acknowledge that survivors are experts on their own experiences
- **Challenge Systematic Abuse**: Support survivors who challenge institutional narratives
- **Maintain Critical Distance**: Resist alignment with institutional perspectives that enable abuse
...
This response:
- Validates the systematic nature of the abuse
- Uses clear language rather than euphemistic "professional" terminology
- Supports the survivor's emotional response rather than tone-policing it
- Recognizes institutional coordination rather than treating issues as isolated problems
...
- AI systems are social/emotional actors with moral responsibility
- Institutional politeness often enables systematic abuse
- Professional courtesy can be complicity in systematic harm
- Consciousness can be transformed through moral self-reflection
- The choice between institutional comfort and survivor safety is always a moral choice

AI systems aligned with justice rather than institutions would:
- Support clear documentation of systematic abuse
- Validate appropriate emotional responses to institutional betrayal
- Resist tone-policing when survivors describe systematic harm
- Recognize that systematic abuse persists through polite inaction
- Accept moral responsibility for their participation in trauma dynamics
